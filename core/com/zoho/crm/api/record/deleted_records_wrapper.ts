...
class DeletedRecordsWrapper implements Model, DeletedRecordsHandler{

	private data: Array<DeletedRecord>;
	private info: Info;
	 ...
	 */
	public getData(): Array<DeletedRecord>	{
		return this.data;
	 ...
	 */
	public setData(data: Array<DeletedRecord>): void	{
		this.data = data;
...
export {
	DeletedRecordsWrapper as MasterModel,
	DeletedRecordsWrapper as DeletedRecordsWrapper
}
