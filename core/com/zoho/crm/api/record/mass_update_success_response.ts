...
class MassUpdateSuccessResponse implements Model, MassUpdateActionResponse{
...
export {
	MassUpdateSuccessResponse as MasterModel,
	MassUpdateSuccessResponse as MassUpdateSuccessResponse
}
