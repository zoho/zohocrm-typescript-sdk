...
class CommonAPIHandler {
    ...
    private parameters: ParameterMap =  new ParameterMap();
	 ...
	 */
    public setParam(param: ParameterMap | undefined) {
        if(param == undefined) {
            return;
        }
	 ...
	 */
    public setHeader(header: HeaderMap | undefined) {
        if(header === undefined) {
            return;
        }
	 ...
	 */
    public getMandatoryChecker() : boolean | null {
